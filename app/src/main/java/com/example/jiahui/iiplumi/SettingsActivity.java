...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText sNewPw = null;
    private EditText sCfmPw = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.settings:
                        ...
                        Intent ii = new Intent(SettingsActivity.this, SettingsActivity.class);
                        startActivity(ii);
                        return true;
                    case R.id.options:
                        Toast.makeText(getApplicationContext(), "Options Selected", Toast.LENGTH_SHORT).show();
                        Intent iii = new Intent(SettingsActivity.this, OptionsActivity.class);
                        startActivity(iii);
                        return true;
                    case R.id.logout:
                        ...
                        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent iv = new Intent(SettingsActivity.this, LoginActivity.class);
                                startActivity(iv);
                                finish();
                            }
                        });
        ...
        sNewPw = (EditText) findViewById(R.id.newPassword);
        sCfmPw = (EditText) findViewById(R.id.cfmPassword);
    }

    public void onChgPwButtonClick (View v) {

        if (sCfmPw.getText().toString().equals(sNewPw.getText().toString())) {

            // insert in code to be saved into database if both equals

        } else {
            sCfmPw.setError("Make sure that passwords match");
        }
    }
