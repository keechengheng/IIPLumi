            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.settings:
                        ...
                        Intent ii = new Intent(OptionsActivity.this, SettingsActivity.class);
                        startActivity(ii);
                        return true;
                    case R.id.options:
                        Toast.makeText(getApplicationContext(), "Options Selected", Toast.LENGTH_SHORT).show();
                        Intent iii = new Intent(OptionsActivity.this, OptionsActivity.class);
                        startActivity(iii);
                        return true;
                    case R.id.logout:
                        ...
                        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent iv = new Intent(OptionsActivity.this, LoginActivity.class);
                                startActivity(iv);
                                finish();
                            }
                        });
